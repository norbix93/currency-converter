...
class TestStage6(StageTest):
    ...
    def generate(self) -> List[TestCase]:
        inputs = [['usd', 'eur', '20', 'nok', '45', 'sek', '75', 'nok', '55', 'isk', '91', ''],
                  ['rub', 'jpy', '80', 'jpy', '95', ''],
                  ['ils', 'usd', '45', 'chf', '57', 'eur', '33', ''],
                  ['cad', 'dkk', '15', 'aud', '35', 'pkr', '41', '']]
        ...
        list_tests = [
            ...
            TestCase(stdin=inputs[2], attach=[['USD', 'is in the cache'], ['CHF', 'is not in the cache'],
                                              ['EUR', 'is in the cache']]),
            TestCase(stdin=inputs[3], attach=[['DKK', 'is not in the cache'], ['AUD', 'is not in the cache'],
